...
public class turismo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar Plan" }));
        jPanel1.add(jComboBox1);
        jComboBox1.setBounds(150, 160, 180, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("./img/turismo.png"))); // NOI18N
        jPanel1.add(jLabel1);
